...
2 - Ma trận hiệp phương sai $\mathbf{\Sigma}$ 
...
- Các phần tử ngoài đường chéo: Là hiệp phương sai giữa 2 chiều bất kỳ ($\operatorname{Cov}(X_i, X_j)$), phản ánh mức độ biến thiên giữa các chiều
...
3 - Isotropic Gaussian $\mathbf{\Sigma} = \sigma^2 \mathbf{I}$

Dạng $\mathbf{\Sigma} = \sigma^2 \mathbf{I}$, xuất hiện khi thỏa mãn 2 điều kiện:
...
$\mathbf{\Sigma} = \begin{bmatrix} \sigma^2 & 0 \\ 0 & \sigma^2 \end{bmatrix} = \sigma^2 \mathbf{I}$
